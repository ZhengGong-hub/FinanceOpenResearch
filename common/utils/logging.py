...
file_handler = logging.FileHandler(f"logs/finresearch_{datetime.now().strftime('%Y%m%d')}.log")
if LOG_FORMAT.lower() == "json":
...
error_handler = logging.FileHandler(f"logs/finresearch_errors_{datetime.now().strftime('%Y%m%d')}.log")
